...
{
    public partial class AllParkingSpacesReportView : Form
    {
        public AllParkingSpacesReportView()
        {
            InitializeComponent();
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportPath = @"D:\Repos\AD\Coursework1\AD_Coursework1\ApartmentLeaseReportingApp\ParkingSpacesReport.rdlc";
        ...
        private DataTable GetData()
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand("Select * from ParkingSpaces", connection);
