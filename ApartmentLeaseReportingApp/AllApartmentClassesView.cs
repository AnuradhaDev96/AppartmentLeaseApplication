...
{
    public partial class AllApartmentClassesView : Form
    {
        public AllApartmentClassesView()
        {
            InitializeComponent();
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportPath = @"D:\Repos\AD\Coursework1\AD_Coursework1\ApartmentLeaseReportingApp\AllApartmentClassesReport.rdlc";
        ...
        private DataTable GetData()
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand("[GetAllApartmentClasses]", connection);
